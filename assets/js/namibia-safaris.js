const main = () => {
  ...
  Object.keys(destinations).forEach((key) => {
    destinationsHtml += `<section class="destination-wrapper">
  ...
  if (document.getElementById('destination-wrapper')) {
    document.getElementById('destination-wrapper').innerHTML = destinationsHtml;
  }
